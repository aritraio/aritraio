...
| :--- | :--- | :--- |
| **[GoQueue](https://github.com/aritraio/goqueue)**<br/>`Distributed Task Engine` | • Coordinator-Worker architecture with **bidirectional gRPC streaming**.<br/>• Active lease heartbeats, zombie fencing & **atomic Redis Lua** state transitions.<br/>• W3C distributed trace propagation & resilient Dead Letter Queues (DLQ). | `Go` `gRPC`<br/>`Redis` `Protobuf`<br/>`OpenTelemetry` |
